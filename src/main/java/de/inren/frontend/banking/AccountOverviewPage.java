...
import de.inren.frontend.banking.common.AccountOverviewTablePanel;
 ...
 *
 */
@MountPath(value = "/accountOverview")
public class AccountOverviewPage extends SecuredPage<AccountState> {
    ...
    public Component createPanel(String wicketId) {
        return new AccountOverviewTablePanel(wicketId);
    }
